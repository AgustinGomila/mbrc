...
fun SettingsScreen(
  ...
  SettingsScreen(openDrawer, uiState, actions, navigateToConnectionManager)
}
...
private fun SettingsScreen(
  ...
  Column(
    ...
    RemoteTopAppBar(openDrawer = openDrawer, title = stringResource(id = R.string.nav_settings))
...
private fun SettingsScreenPreview() {
  RemoteTheme {
    SettingsScreen(openDrawer = {}, navigateToConnectionManager = { })
  }
}
